...
namespace ColorPickerWPF
{
    ...
    public partial class ColorPickerWindow : Window
    {
        ...
        public static bool ShowDialog(out Color color, Color colorin, ColorPickerDialogOptions flags = ColorPickerDialogOptions.None, string customPaletteName = null)
        {
            var instance = new ColorPickerWindow();
            color = colorin;
            instance.ColorPicker.Color = colorin;
            instance.ColorPicker.SetColor(colorin);
